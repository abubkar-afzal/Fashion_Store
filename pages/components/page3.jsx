...
const Page3 = ()=>{
    return( <>
        <div className=" xsm:bg-white xsm:text-center sm:grid sm:grid-cols-2  m-[1rem] my-[2rem] ">
        ...
        <h1 className="xsm:text-[3rem] xsm:font-bold xsm:text-left xsm:m-2">
            ...
            <div className="sm:row-start-1 sm:place-self-center justify-items-end mx-[1rem]">
            <Image src={best} alt="" width={1200} height={1200} className="xsm:w-[300px] sm:w-[350px]  xsm:mr-[2rem] xsm:pt-4 xsm:rounded-tl-[7rem] xsm:place-self-center" />
            <div className="xsm:text-[15px] xsm:mt-[-2rem]  xsm:grid xsm:grid-cols-3 xsm:gap-x-[3px] xsm:w-[15rem] xsm:bg-white xsm:shadow-xl sm:w-[30rem] sm:ml-[30rem] sm:text-[20px] ">
