...
const Women = ({ allProducts, showCart,checkloginornot }) => {
  ...
  return (
    <>
      <Fade duration={2000}>
        <div className=" flex flex-wrap space-x-[1rem] space-y-[2rem] mx-[2rem] justify-center mb-[2rem] min-h-screen content-center overflow-y-scroll hideBar">
          <div></div>
                ...
                {item.product_quantity == 0 ? (
                  <>
                    <div className="relative">
                      <div className="font-black xsm:text-[14px] sm:text-[16px] bg-[---c1] absolute w-full  sm:top-52 xsm:top-40 text-center">
                        Out Of Stock !!
                      </div>
                    </div>
                    ...
                    <div className="flex xsm:flex-col xsm:space-y-2 xsm:items-center sm:justify-between space-x-[1rem]  bg-white p-2">
                      ...
                      <Link href={`${process.env.NEXT_PUBLIC_HOST}/components/buyNow`}>
                        <button
                          ...
                          className="font-black xsm:text-[10px] sm:text-[12px] bg-[---c2] p-2 sm:px-4 xsm:px-3 text-white rounded-[2rem] flex  items-center hover:bg-[---c1]"
                        >
                          Buy Now
                          <FaShoppingBag className="xsm:text-[10px] sm:text-[12px] mx-1" />
                        </button>
