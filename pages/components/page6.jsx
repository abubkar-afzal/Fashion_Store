...
const Page6 = ({DealOfDay})=>{
    return(<>
             <div className=" overflow-hidden xsm:text-left xsm:bg-[---c1] xsm:content-center xsm:items-center  ">
                {DealOfDay.map((item)=>{
                    return(
        	    <div key={item._id} className="sm:grid sm:grid-cols-2 ">
                    ...
                    <Image src={item.product_img} width={1200} height={1200} alt="" className="xsm:px-4  xsm:w-[400px] xsm:h-[400px] sm:w-[500px] sm:h-[500px] sm:py-[2rem]" />
                    </div>)
                })}   
         </div>
    </>)
