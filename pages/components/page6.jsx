    ...
    return(<>
             <div className=" overflow-hidden xsm:text-left xsm:bg-[---c1] xsm:content-center xsm:items-center  ">
        	    ...
        	    <div key={item._id} className="sm:grid sm:grid-cols-2 items-center ">
                    ...
                    <button onClick={() => { handleAddToCart(item) }}  className=" h-[3rem] mb-8 xsm:rounded-md xsm:text-[1rem] xsm:font-bold xsm:m-3 xsm:text-white xsm:bg-[---c4] font-black sm:px-4 xsm:px-3 flex  items-center hover:bg-[---b4]">Add To Cart </button>
                    </div>
