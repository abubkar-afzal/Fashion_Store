    ...
    <Fade duration={2000}>
      ...
      <div  className={`${open  ? "blurred-background":null} xsm:mt-[5rem] mb-[2rem] min-h-screen content-center overflow-y-scroll hideBar bg-[---blur] m-[1rem] rounded-[1rem] py-[1rem]`}>
        ...
        <div className="justify-items-center text-center " >
          <h1 className="xsm:text-[20px] sm:text-[24px] font-black text-white">!!~~CheckOut~~!!</h1>
          ...
          <p className="xsm:text-[14px] sm:text-[18px] font-semibold text-white">Please Check That What You Need To Buy. Beacause Checkout Is Not A Cup Of Tea !!</p>
        </div>
