...
const Page2 = ()=>{
    return(<>
        <div className="xsh:h-[932px] bg-white xsm:overflow-y-hidden xsm:m-4 sm:place-content-center sm:text-center sh:h-[600px]">
            ...
            <img src={pic2} alt="pic2" className="xsm:cursor-pointer sm:w-[15rem]" />
            <img src={pic3} alt="pic3" className="xsm:cursor-pointer sm:w-[15rem]" />
            <img src={pic4} alt="pic4" className="xsm:cursor-pointer sm:w-[15rem]" />
