    ...
    <>
      <div className="  overflow-hidden xsm:text-center xsm:bg-white  xsm:items-center">
        <div className="flex flex-wrap space-x-4 space-y-2 place-content-center">
            <div></div>
          <img src={footerpic1} alt="" className="xsm:w-[6.5rem] xsm:h-[6.5rem] sm:w-[10rem] sm:h-[10rem]" />
          <img src={footerpic2} alt="" className="xsm:w-[6.5rem] xsm:h-[6.5rem] sm:w-[10rem] sm:h-[10rem]" />
          <img src={footerpic3} alt="" className="xsm:w-[6.5rem] xsm:h-[6.5rem] sm:w-[10rem] sm:h-[10rem]" />
          <img src={footerpic4} alt="" className="xsm:w-[6.5rem] xsm:h-[6.5rem] sm:w-[10rem] sm:h-[10rem]" />
          <img src={footerpic5} alt="" className="xsm:w-[6.5rem] xsm:h-[6.5rem] sm:w-[10rem] sm:h-[10rem]" />
