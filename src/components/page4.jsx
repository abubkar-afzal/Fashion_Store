...
const Page4 = ()=>{
    ...
    return(
        ...
        <div className="xsh:h-[932px] overflow-hidden xsm:text-left xsm:bg-[---c4] xsm:p-5 xsm:pt-[2rem]  sh:h-[500px]">
            ...
            <div className="Images" >
                <img src={img1} alt="" className="w-[18rem] h-[18rem]" />
            ...
            <div className="Images">
                <img src={img2} alt="" className="w-[18rem] h-[18rem]" />
                <div className="xsm:bg-white xsm:space-y-2 p-2 xsm:w-[18rem]">
                <div className="flex">
                <IoIosStar />
                <IoIosStar />
            ...
            <div className="Images">
                <img src={img3} alt="" className="w-[18rem] h-[18rem]" />
                <div className="xsm:bg-white xsm:space-y-2 p-2 xsm:w-[18rem]">
                <div className="flex">
                <IoIosStar />
                <IoIosStar />
            ...
            <div className="Images">
                <img src={img4} alt="" className="w-[18rem] h-[18rem]" />
                <div className="xsm:bg-white xsm:space-y-2 p-2 xsm:w-[18rem]">
                <div className="flex">
                <IoIosStar />
                <IoIosStar />
            ...
            <div className="xsm:space-x-3 pt-8 xsm:text-center">
                <input onClick={slide1} type="radio" name="img1" id="img1" className="radio" />
                <input onClick={slide2} type="radio" name="img1" id="img2" className="radio" />
                <input onClick={slide3} type="radio" name="img1" id="img3" className="radio" />
                <input onClick={slide4} type="radio" name="img1" id="img4" className="radio" />
            </div></div>
            </div>
        </div>
        </>
